...
class EcuOperations : public QWidget
{
  ...
  public:
    ...
    int write_mem_16bit_kline(FileActions::EcuCalDefStructure *ecuCalDef, bool test_write_arg);
    int write_mem_32bit_kline(FileActions::EcuCalDefStructure *ecuCalDef, bool test_write_arg);
    int write_mem_32bit_can(FileActions::EcuCalDefStructure *ecuCalDef, bool test_write_arg);
    int write_mem_32bit_iso15765(FileActions::EcuCalDefStructure *ecuCalDef, bool test_write_arg);
