...
class FlashEcuSubaruDenso1N83M_4MCan : public QDialog
{
  ...
  public:
    explicit FlashEcuSubaruDenso1N83M_4MCan(SerialPortActions *serial, FileActions::EcuCalDefStructure *ecuCalDef, const QString& cmd_type, QWidget *parent = nullptr);
