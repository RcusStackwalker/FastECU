...
FlashEcuSubaruDensoSH72543CanDiesel::FlashEcuSubaruDensoSH72543CanDiesel(SerialPortActions *serial,
...
void FlashEcuSubaruDensoSH72543CanDiesel::run()
{
    ...
    case QMessageBox::Ok:
    {
        ...
        connect(m_operation, &FlashOperationWorker::progressChanged, this,
                &FlashEcuSubaruDensoSH72543CanDiesel::set_progressbar_value);
