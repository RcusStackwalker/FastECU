...
void EepromEcuSubaruDensoSH705xKline::run()
{
    ...
    case QMessageBox::Ok:
    {
        m_operation = new EepromEcuSubaruDensoSH705xKlineOperation(serial, ecuCalDef, cmd_type, this);
        connect(m_operation, &FlashOperationWorker::LOG_E, this, &EepromEcuSubaruDensoSH705xKline::LOG_E);
        connect(m_operation, &FlashOperationWorker::LOG_W, this, &EepromEcuSubaruDensoSH705xKline::LOG_W);
