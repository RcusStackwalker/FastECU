 ...
 * @return success
 */
int FlashEcuSubaruUnisiaJecsM32rOperation::read_mem(uint32_t start_addr, uint32_t length)
{
    QElapsedTimer timer;
 ...
 * @return success
 */
int FlashEcuSubaruUnisiaJecsM32rOperation::write_mem()
{
    ...
    for (int i = 0; i < 40; i++)
    {
        ...
        if (received.length() > 6)
        {
            ...
            else
            {
                ...
                emit LOG_E("Received: " + bytes::toHex(received), true, true);
                return STATUS_ERROR;
            }
        }
        delay(500);
 ...
 */
QByteArray FlashEcuSubaruUnisiaJecsM32rOperation::send_sid_bf_ssm_init()
{
    QByteArray output;
    QByteArray received;
...
QByteArray FlashEcuSubaruUnisiaJecsM32rOperation::send_sid_b8_change_baudrate_4800()
{
    QByteArray output;
    QByteArray received;
...
QByteArray FlashEcuSubaruUnisiaJecsM32rOperation::send_sid_b8_change_baudrate_38400()
{
    QByteArray output;
    QByteArray received;
...
QByteArray FlashEcuSubaruUnisiaJecsM32rOperation::send_sid_af_enter_flash_mode(const QByteArray& ecu_id)
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
...
QByteArray FlashEcuSubaruUnisiaJecsM32rOperation::send_sid_af_erase_memory_block()
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
