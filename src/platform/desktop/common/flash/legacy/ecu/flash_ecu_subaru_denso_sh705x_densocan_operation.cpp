 ...
 * @return success
 */
int FlashEcuSubaruDensoSH705xDensoCanOperation::connect_bootloader()
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
    ...
    confirm(tr("Connecting to ECU"), tr("Press OK and then turn ignition ON to start initializing connection to ECU"),
 ...
 * @return success
 */
int FlashEcuSubaruDensoSH705xDensoCanOperation::read_mem(uint32_t start_addr, uint32_t length)
{
    QElapsedTimer timer;
    QByteArray output;
    QByteArray received;
 ...
 * @return
 */
int FlashEcuSubaruDensoSH705xDensoCanOperation::get_changed_blocks(const uint8_t *src, int *modified)
{
    unsigned blockno;
    QByteArray msg;
 ...
 * @return
 */
int FlashEcuSubaruDensoSH705xDensoCanOperation::check_romcrc(const uint8_t *src, uint32_t addr, uint32_t len,
                                                             int *modified)
{
    QByteArray output;
    QByteArray received;
...
int FlashEcuSubaruDensoSH705xDensoCanOperation::init_flash_write()
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
 ...
 * @return success
 */
int FlashEcuSubaruDensoSH705xDensoCanOperation::flash_block(const uint8_t *src, uint32_t start, uint32_t len)
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
 ...
 * @return kernel id
 */
QByteArray FlashEcuSubaruDensoSH705xDensoCanOperation::request_kernel_id()
{
    QByteArray output;
    QByteArray received;
    QByteArray kernelid;
