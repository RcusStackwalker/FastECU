...
// Worker-thread half of FlashEcuSubaruDenso1N83M_4MCan (worker-thread migration).
// Owns every serial-> call and the Subaru Denso 1N83M/4M CAN bootloader
// protocol sequence; relocated verbatim from
// FlashEcuSubaruDenso1N83M_4MCan's former private methods.
class FlashEcuSubaruDenso1N83M_4MCanOperation : public FlashOperationWorker
{
    Q_OBJECT

  public:
    FlashEcuSubaruDenso1N83M_4MCanOperation(SerialPortActions *serial, FileActions::EcuCalDefStructure *ecuCalDef,
