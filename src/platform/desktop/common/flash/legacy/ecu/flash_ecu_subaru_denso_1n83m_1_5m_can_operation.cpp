...
bool FlashEcuSubaruDenso1N83M_1_5MCanOperation::execute()
{
 ...
 * @return success
 */
int FlashEcuSubaruDenso1N83M_1_5MCanOperation::connect_bootloader()
{
    QByteArray output;
    QByteArray received;
    QByteArray seed;
 ...
 * @return success
 */
int FlashEcuSubaruDenso1N83M_1_5MCanOperation::read_memory(uint32_t start_addr, uint32_t length)
{
    QElapsedTimer timer;
    QByteArray output;
    QByteArray received;
    ...
    length = 0x00173F00; // hack for testing
...
int FlashEcuSubaruDenso1N83M_1_5MCanOperation::write_memory(bool test_write_arg)
{
    QByteArray filedata;
 ...
 * @return success
 */
int FlashEcuSubaruDenso1N83M_1_5MCanOperation::reflash_block(const uint8_t *newdata, const struct flashdev_t *fdt,
 ...
 * @return success
 */
int FlashEcuSubaruDenso1N83M_1_5MCanOperation::erase_memory()
{
    QByteArray output;
    QByteArray received;
