...
class TestMenuCommand : public QObject
{
  ...
  private slots:
    void activeMenuIds_mapToCommands_data()
    {
        ...
        QTest::newRow("interpolate_horizontal")
            << QStringLiteral("interpolate_horizontal") << MenuCommand::InterpolateHorizontal;
        QTest::newRow("interpolate_vertical")
            << QStringLiteral("interpolate_vertical") << MenuCommand::InterpolateVertical;
        QTest::newRow("interpolate_bidirectional")
            << QStringLiteral("interpolate_bidirectional") << MenuCommand::InterpolateBidirectional;
        ...
        QTest::newRow("test_write_rom_to_ecu")
            << QStringLiteral("test_write_rom_to_ecu") << MenuCommand::TestWriteRomToEcu;
        ...
        QTest::newRow("winols_csv_to_romraider_xml")
            << QStringLiteral("winols_csv_to_romraider_xml") << MenuCommand::WinolsCsvToRomRaiderXml;
...
QTEST_APPLESS_MAIN(TestMenuCommand)

#include "menu_command_qt_compat_test.moc"
