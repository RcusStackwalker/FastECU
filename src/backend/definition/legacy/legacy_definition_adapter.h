...
class LegacyDefinitionAdapter
{
  public:
    ...
    Status replace_romraider_catalog(definitions::ConfigValuesStructure&, std::span<const std::string> ordered_handles);
    Status replace_ecuflash_catalog(definitions::ConfigValuesStructure&, std::string_view directory,
