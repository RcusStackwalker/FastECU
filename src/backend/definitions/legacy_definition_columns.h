...
inline ScalingDestination map_scaling_destination(EcuCalDefStructure& value)
{
    return {
...
inline ScalingDestination axis_scaling_destination(EcuCalDefStructure& value, bool x_axis)
{
    AxisColumns axis = axis_columns(value, x_axis);
    return {
        axis.scaling_name,
        axis.storage,
        axis.units,
