 ...
 * @return success
 */
int FlashEcuSubaruUnisiaJecsM32rBootModeOperation::read_mem(uint32_t start_addr, uint32_t length)
{
    QElapsedTimer timer;
 ...
 *
 */
int FlashEcuSubaruUnisiaJecsM32rBootModeOperation::write_mem()
{
    QByteArray output;
    QByteArray received;
    QString msg;
 ...
 */
QByteArray FlashEcuSubaruUnisiaJecsM32rBootModeOperation::send_sid_bf_ssm_init()
{
    QByteArray output;
    QByteArray received;
    uint8_t loop_cnt = 0;
...
QByteArray FlashEcuSubaruUnisiaJecsM32rBootModeOperation::send_subaru_sid_b8_change_baudrate_4800()
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
...
QByteArray FlashEcuSubaruUnisiaJecsM32rBootModeOperation::send_subaru_sid_b8_change_baudrate_38400()
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
 ...
 */
QByteArray FlashEcuSubaruUnisiaJecsM32rBootModeOperation::add_ssm_header(QByteArray output, uint8_t tester_id, uint8_t target_id, bool dec_0x100)
{
 ...
 */
uint8_t FlashEcuSubaruUnisiaJecsM32rBootModeOperation::calculate_checksum(QByteArray output, bool dec_0x100)
{
    uint8_t checksum = 0;
 ...
 * @return parsed message
 */
QString FlashEcuSubaruUnisiaJecsM32rBootModeOperation::parse_message_to_hex(QByteArray received)
{
    QString msg;
