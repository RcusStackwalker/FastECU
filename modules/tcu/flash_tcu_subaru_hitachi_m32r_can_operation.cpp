#include "flash_tcu_subaru_hitachi_m32r_can_operation.h"
 ...
 * @return success
 */
int FlashTcuSubaruHitachiM32rCanOperation::reflash_block(const uint8_t *newdata, const struct flashdev_t *fdt, unsigned blockno, bool test_write)
{
 ...
 * @return seed key (4 bytes)
 */
QByteArray FlashTcuSubaruHitachiM32rCanOperation::calculate_seed_key(QByteArray requested_seed, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray key;
...
QByteArray FlashTcuSubaruHitachiM32rCanOperation::calculate_payload(QByteArray buf, uint32_t len, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray encrypted;
 ...
 */
QString FlashTcuSubaruHitachiM32rCanOperation::parse_message_to_hex(QByteArray received)
{
    QString msg;
