...
bool FlashTcuCvtSubaruMitsuMH8111CanOperation::execute()
{
 ...
 * @return success
 */
int FlashTcuCvtSubaruMitsuMH8111CanOperation::connect_bootloader()
{
    QByteArray output;
    QByteArray received;
    QByteArray seed;
 ...
 * @return success
 */
int FlashTcuCvtSubaruMitsuMH8111CanOperation::read_mem(uint32_t start_addr, uint32_t length)
{
    QElapsedTimer timer;
    QByteArray output;
    QByteArray received;
...
int FlashTcuCvtSubaruMitsuMH8111CanOperation::write_mem(bool test_write)
{
    QByteArray filedata;
 ...
 * @return success
 */
int FlashTcuCvtSubaruMitsuMH8111CanOperation::reflash_block(const uint8_t *newdata, const struct flashdev_t *fdt, unsigned blockno, bool test_write)
{
 ...
 * @return success
 */
int FlashTcuCvtSubaruMitsuMH8111CanOperation::erase_mem()
{
    QByteArray output;
    QByteArray received;
 ...
 */
QByteArray FlashTcuCvtSubaruMitsuMH8111CanOperation::generate_seed_key(QByteArray requested_seed)
{
    QByteArray key;
 ...
 * @return seed key (4 bytes)
 */
QByteArray FlashTcuCvtSubaruMitsuMH8111CanOperation::calculate_seed_key(QByteArray requested_seed, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray key;
...
QByteArray FlashTcuCvtSubaruMitsuMH8111CanOperation::encrypt_payload(QByteArray buf, uint32_t len)
{
...
QByteArray FlashTcuCvtSubaruMitsuMH8111CanOperation::decrypt_payload(QByteArray buf, uint32_t len)
{
    QByteArray decrypt;
...
QByteArray FlashTcuCvtSubaruMitsuMH8111CanOperation::calculate_payload(QByteArray buf, uint32_t len, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray encrypted;
 ...
 */
QString FlashTcuCvtSubaruMitsuMH8111CanOperation::parse_message_to_hex(QByteArray received)
{
    QString msg;
