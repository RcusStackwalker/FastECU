#ifndef FLASH_TCU_CVT_SUBARU_HITACHI_M32R_CAN_OPERATION_H
#define FLASH_TCU_CVT_SUBARU_HITACHI_M32R_CAN_OPERATION_H
...
// Worker-thread half of FlashTcuCvtSubaruHitachiM32rCan (worker-thread migration).
// Owns every serial-> call and the Subaru CVT TCU Hitachi CAN bootloader
// protocol sequence; relocated verbatim from
// FlashTcuCvtSubaruHitachiM32rCan's former private methods.
class FlashTcuCvtSubaruHitachiM32rCanOperation : public FlashOperationWorker
{
    Q_OBJECT

  public:
    FlashTcuCvtSubaruHitachiM32rCanOperation(SerialPortActions *serial,
...
#endif // FLASH_TCU_CVT_SUBARU_HITACHI_M32R_CAN_OPERATION_H
