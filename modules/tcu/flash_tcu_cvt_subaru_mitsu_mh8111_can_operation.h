...
// Worker-thread half of FlashTcuCvtSubaruMitsuMH8111Can (worker-thread migration).
// Owns every serial-> call and the Subaru CVT TCU Mitsubishi MH8111 CAN
// bootloader protocol sequence; relocated verbatim from
// FlashTcuCvtSubaruMitsuMH8111Can's former private methods.
class FlashTcuCvtSubaruMitsuMH8111CanOperation : public FlashOperationWorker
{
    Q_OBJECT

public:
    FlashTcuCvtSubaruMitsuMH8111CanOperation(SerialPortActions *serial,
