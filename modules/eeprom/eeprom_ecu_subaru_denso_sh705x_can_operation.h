#ifndef EEPROM_ECU_SUBARU_DENSO_SH705X_CAN_OPERATION_H
#define EEPROM_ECU_SUBARU_DENSO_SH705X_CAN_OPERATION_H
...
// Worker-thread half of EepromEcuSubaruDensoSH705xCan (worker-thread migration).
// Owns every serial-> call and the Subaru Denso 07+ 32-bit CAN EEPROM
// dump sequence; relocated verbatim from
// EepromEcuSubaruDensoSH705xCan's former private methods.
class EepromEcuSubaruDensoSH705xCanOperation : public FlashOperationWorker
{
    Q_OBJECT
...
#endif // EEPROM_ECU_SUBARU_DENSO_SH705X_CAN_OPERATION_H
