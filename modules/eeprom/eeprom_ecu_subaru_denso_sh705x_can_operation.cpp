...
bool EepromEcuSubaruDensoSH705xCanOperation::execute()
{
    ...
    for (int i = 2; i < 5; i++)
    {
        ...
        if (result == STATUS_SUCCESS)
        {
            if (cmd_type == "read")
            {
                emit externalLoggerMessage("Reading EEPROM, please wait...");
 ...
 * @return success
 */
int EepromEcuSubaruDensoSH705xCanOperation::connect_bootloader()
{
    QByteArray output;
    QByteArray received;
    QByteArray seed;
...
uint32_t EepromEcuSubaruDensoSH705xCanOperation::read_ram_location(uint32_t loc)
{
    QByteArray output;
    QByteArray received;
    QByteArray response;
 ...
 * @return success
 */
int EepromEcuSubaruDensoSH705xCanOperation::upload_kernel(const QString& kernel, uint32_t kernel_start_addr)
{
    QFile file(kernel);
 ...
 * @return success
 */
int EepromEcuSubaruDensoSH705xCanOperation::read_mem(uint32_t start_addr, uint32_t length)
{
    QElapsedTimer timer;
    QByteArray output;
    QByteArray received;
 ...
 */
QByteArray EepromEcuSubaruDensoSH705xCanOperation::generate_seed_key(const QByteArray& requested_seed)
{
    QByteArray key;
...
QByteArray EepromEcuSubaruDensoSH705xCanOperation::generate_ecutek_racerom_can_seed_key(const QByteArray& requested_seed)
{
 ...
 * @return seed key (4 bytes)
 */
QByteArray EepromEcuSubaruDensoSH705xCanOperation::generate_ecutek_seed_key(const QByteArray& requested_seed)
{
    QByteArray seed_key;
 ...
 ***********************************/
QByteArray EepromEcuSubaruDensoSH705xCanOperation::generate_cobb_seed_key(const QByteArray& requested_seed)
{
    QByteArray key;
 ...
 */
QByteArray EepromEcuSubaruDensoSH705xCanOperation::encrypt_payload(const QByteArray& buf, uint32_t len)
{
...
QByteArray EepromEcuSubaruDensoSH705xCanOperation::decrypt_payload(const QByteArray& buf, uint32_t len)
{
    QByteArray decrypt;
 ...
 * @return kernel id
 */
QByteArray EepromEcuSubaruDensoSH705xCanOperation::request_kernel_id()
{
    QByteArray output;
    QByteArray received;
    QByteArray kernelid;
