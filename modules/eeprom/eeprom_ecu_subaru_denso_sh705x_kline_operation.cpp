 ...
 * @return success
 */
int EepromEcuSubaruDensoSH705xKlineOperation::upload_kernel(QString kernel, uint32_t kernel_start_addr)
{
    QFile file(kernel);
 ...
 * @return received response
 */
QByteArray EepromEcuSubaruDensoSH705xKlineOperation::send_sid_27_send_seed_key(QByteArray seed_key)
{
    QByteArray output;
    QByteArray received;
 ...
 * @return received response
 */
QByteArray EepromEcuSubaruDensoSH705xKlineOperation::send_sid_36_transferdata(uint32_t dataaddr, QByteArray buf, uint32_t len)
{
    QByteArray output;
    QByteArray received;
 ...
 */
QByteArray EepromEcuSubaruDensoSH705xKlineOperation::generate_seed_key(QByteArray requested_seed)
{
    QByteArray key;
 ...
 * @return seed key (4 bytes)
 */
QByteArray EepromEcuSubaruDensoSH705xKlineOperation::generate_ecutek_seed_key(QByteArray requested_seed)
{
    QByteArray key;
 ...
 * @return seed key (4 bytes)
 */
QByteArray EepromEcuSubaruDensoSH705xKlineOperation::calculate_seed_key(QByteArray requested_seed, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray key;
 ...
 */
QByteArray EepromEcuSubaruDensoSH705xKlineOperation::encrypt_payload(QByteArray buf, uint32_t len)
{
...
QByteArray EepromEcuSubaruDensoSH705xKlineOperation::decrypt_payload(QByteArray buf, uint32_t len)
{
...
QByteArray EepromEcuSubaruDensoSH705xKlineOperation::calculate_payload(QByteArray buf, uint32_t len, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray encrypted;
 ...
 */
QByteArray EepromEcuSubaruDensoSH705xKlineOperation::add_ssm_header(QByteArray output, uint8_t tester_id, uint8_t target_id, bool dec_0x100)
{
 ...
 */
uint8_t EepromEcuSubaruDensoSH705xKlineOperation::calculate_checksum(QByteArray output, bool dec_0x100)
{
    uint8_t checksum = 0;
 ...
 * @return parsed message
 */
QString EepromEcuSubaruDensoSH705xKlineOperation::parse_message_to_hex(QByteArray received)
{
    QString msg;
