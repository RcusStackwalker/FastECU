...
void FlashEcuSubaruHitachiM32rCan::run()
{
    ...
    case QMessageBox::Ok:
    {
        m_operation = new FlashEcuSubaruHitachiM32rCanOperation(serial, ecuCalDef, cmd_type, this);
        connect(m_operation, &FlashOperationWorker::LOG_E, this, &FlashEcuSubaruHitachiM32rCan::LOG_E);
        connect(m_operation, &FlashOperationWorker::LOG_W, this, &FlashEcuSubaruHitachiM32rCan::LOG_W);
        connect(m_operation, &FlashOperationWorker::LOG_I, this, &FlashEcuSubaruHitachiM32rCan::LOG_I);
        connect(m_operation, &FlashOperationWorker::LOG_D, this, &FlashEcuSubaruHitachiM32rCan::LOG_D);
        ...
        connect(m_operation, &FlashOperationWorker::progressChanged,
                this, &FlashEcuSubaruHitachiM32rCan::set_progressbar_value);
