#ifndef FLASH_ECU_SUBARU_DENSO_SH72531_CAN_OPERATION_H
#define FLASH_ECU_SUBARU_DENSO_SH72531_CAN_OPERATION_H
...
// Worker-thread half of FlashEcuSubaruDensoSH72531Can (worker-thread migration).
// Owns every serial-> call and the Subaru Denso SH72531 CAN bootloader
// protocol sequence; relocated verbatim from
// FlashEcuSubaruDensoSH72531Can's former private methods.
class FlashEcuSubaruDensoSH72531CanOperation : public FlashOperationWorker
{
    Q_OBJECT

  public:
    FlashEcuSubaruDensoSH72531CanOperation(SerialPortActions *serial,
...
#endif // FLASH_ECU_SUBARU_DENSO_SH72531_CAN_OPERATION_H
