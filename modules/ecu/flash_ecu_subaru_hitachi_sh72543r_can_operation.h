...
// Worker-thread half of FlashEcuSubaruHitachiSH72543rCan (worker-thread migration).
// Owns every serial-> call and the Subaru Hitachi SH72543R CAN bootloader
// protocol sequence; relocated verbatim from
// FlashEcuSubaruHitachiSH72543rCan's former private methods.
class FlashEcuSubaruHitachiSH72543rCanOperation : public FlashOperationWorker
{
    Q_OBJECT
