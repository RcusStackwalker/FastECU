...
bool FlashEcuSubaruHitachiM32rCanOperation::execute()
{
 ...
 * @return success
 */
int FlashEcuSubaruHitachiM32rCanOperation::connect_bootloader()
{
    QByteArray output;
    QByteArray received;
    QByteArray seed;
 ...
 * @return success
 */
int FlashEcuSubaruHitachiM32rCanOperation::read_mem(uint32_t start_addr, uint32_t length)
{
    QElapsedTimer timer;
    QByteArray output;
    QByteArray received;
...
int FlashEcuSubaruHitachiM32rCanOperation::write_mem(bool test_write)
{
    QByteArray filedata;
 ...
 * @return success
 */
int FlashEcuSubaruHitachiM32rCanOperation::reflash_block(const uint8_t *newdata, const struct flashdev_t *fdt, unsigned blockno, bool test_write)
{
 ...
 * @return success
 */
int FlashEcuSubaruHitachiM32rCanOperation::erase_memory()
{
    QByteArray output;
    QByteArray received;
 ...
 */
QByteArray FlashEcuSubaruHitachiM32rCanOperation::generate_seed_key(QByteArray requested_seed)
{
    QByteArray key;
 ...
 * @return seed key (4 bytes)
 */
QByteArray FlashEcuSubaruHitachiM32rCanOperation::calculate_seed_key(QByteArray requested_seed, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray key;
...
QByteArray FlashEcuSubaruHitachiM32rCanOperation::encrypt_payload(QByteArray buf, uint32_t len)
{
...
QByteArray FlashEcuSubaruHitachiM32rCanOperation::decrypt_payload(QByteArray buf, uint32_t len)
{
    QByteArray decrypt;
...
QByteArray FlashEcuSubaruHitachiM32rCanOperation::calculate_payload(QByteArray buf, uint32_t len, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray encrypted;
 ...
 */
QString FlashEcuSubaruHitachiM32rCanOperation::parse_message_to_hex(QByteArray received)
{
    QString msg;
