 ...
 * @return success
 */
int FlashEcuSubaruDenso1N83M_4MCanOperation::reflash_block(const uint8_t *newdata, const struct flashdev_t *fdt, unsigned blockno, bool test_write)
{
 ...
 */
QByteArray FlashEcuSubaruDenso1N83M_4MCanOperation::generate_can_seed_key(QByteArray requested_seed)
{
    QByteArray key;
 ...
 * @return seed key (4 bytes)
 */
QByteArray FlashEcuSubaruDenso1N83M_4MCanOperation::calculate_seed_key(QByteArray requested_seed, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray key;
...
QByteArray FlashEcuSubaruDenso1N83M_4MCanOperation::encrypt_payload(QByteArray buf, uint32_t len)
{
...
QByteArray FlashEcuSubaruDenso1N83M_4MCanOperation::decrypt_payload(QByteArray buf, uint32_t len)
{
    QByteArray decrypt;
...
QByteArray FlashEcuSubaruDenso1N83M_4MCanOperation::calculate_payload(QByteArray buf, uint32_t len, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray encrypted;
 ...
 */
QString FlashEcuSubaruDenso1N83M_4MCanOperation::parse_message_to_hex(QByteArray received)
{
    QString msg;
