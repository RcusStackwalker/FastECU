 ...
 * @return success
 */
int FlashEcuSubaruDenso1N83M_1_5MCanOperation::reflash_block(const uint8_t *newdata, const struct flashdev_t *fdt, unsigned blockno, bool test_write)
{
 ...
 * @return seed key (4 bytes)
 */
QByteArray FlashEcuSubaruDenso1N83M_1_5MCanOperation::calculate_seed_key(QByteArray requested_seed, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray key;
...
QByteArray FlashEcuSubaruDenso1N83M_1_5MCanOperation::calculate_payload(QByteArray buf, uint32_t len, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray encrypted;
 ...
 */
QString FlashEcuSubaruDenso1N83M_1_5MCanOperation::parse_message_to_hex(QByteArray received)
{
    QString msg;
