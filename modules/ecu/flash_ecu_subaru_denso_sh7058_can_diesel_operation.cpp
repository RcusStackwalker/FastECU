 ...
 * @return
 */
int FlashEcuSubaruDensoSH7058CanDieselOperation::check_romcrc(const uint8_t *src, uint32_t start, uint32_t len, int *modified)
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
 ...
 * @return success
 */
int FlashEcuSubaruDensoSH7058CanDieselOperation::reflash_block(const uint8_t *newdata, const struct flashdev_t *fdt, unsigned blockno, bool test_write)
{
