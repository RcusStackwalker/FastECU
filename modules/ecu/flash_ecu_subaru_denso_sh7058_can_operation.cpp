...
FlashEcuSubaruDensoSH7058CanOperation::FlashEcuSubaruDensoSH7058CanOperation(
 ...
 * @return success
 */
int FlashEcuSubaruDensoSH7058CanOperation::upload_kernel(QString kernel, uint32_t kernel_start_addr)
{
    QFile file(kernel);
...
unsigned int FlashEcuSubaruDensoSH7058CanOperation::crc32(const unsigned char *buf, unsigned int len)
{
...
void FlashEcuSubaruDensoSH7058CanOperation::init_crc32_tab( void )
{
    uint32_t i, j;
    uint32_t crc, c;
 ...
 * @return success
 */
int FlashEcuSubaruDensoSH7058CanOperation::reflash_block(const uint8_t *newdata, const struct flashdev_t *fdt, unsigned blockno, bool test_write)
{
 ...
 */
QByteArray FlashEcuSubaruDensoSH7058CanOperation::generate_seed_key(QByteArray requested_seed)
{
    QByteArray key;
...
unsigned long long FlashEcuSubaruDensoSH7058CanOperation::decrypt_racerom_seed(unsigned long long base, unsigned long long exponent, unsigned long long modulus) {
...
QByteArray FlashEcuSubaruDensoSH7058CanOperation::generate_ecutek_racerom_can_seed_key(QByteArray requested_seed)
{
 ...
 * @return seed key (4 bytes)
 */
QByteArray FlashEcuSubaruDensoSH7058CanOperation::generate_ecutek_seed_key(QByteArray requested_seed)
{
    QByteArray seed_key;
 ...
 ***********************************/
QByteArray FlashEcuSubaruDensoSH7058CanOperation::generate_cobb_seed_key(QByteArray requested_seed)
{
    QByteArray key;
 ...
 * @return seed key (4 bytes)
 */
QByteArray FlashEcuSubaruDensoSH7058CanOperation::calculate_seed_key(QByteArray requested_seed, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray key;
 ...
 */
QByteArray FlashEcuSubaruDensoSH7058CanOperation::encrypt_payload(QByteArray buf, uint32_t len)
{
...
QByteArray FlashEcuSubaruDensoSH7058CanOperation::decrypt_payload(QByteArray buf, uint32_t len)
{
    QByteArray decrypt;
...
QByteArray FlashEcuSubaruDensoSH7058CanOperation::calculate_payload(QByteArray buf, uint32_t len, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray encrypted;
 ...
 */
QByteArray FlashEcuSubaruDensoSH7058CanOperation::add_ssm_header(QByteArray output, uint8_t tester_id, uint8_t target_id, bool dec_0x100)
{
 ...
 */
uint8_t FlashEcuSubaruDensoSH7058CanOperation::calculate_checksum(QByteArray output, bool dec_0x100)
{
    uint8_t checksum = 0;
 ...
 * @return parsed message
 */
QString FlashEcuSubaruDensoSH7058CanOperation::parse_message_to_hex(QByteArray received)
{
    QString msg;
