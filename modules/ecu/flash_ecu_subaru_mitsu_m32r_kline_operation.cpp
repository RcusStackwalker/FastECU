...
bool FlashEcuSubaruMitsuM32rKlineOperation::execute()
{
 ...
 * @return success
 */
int FlashEcuSubaruMitsuM32rKlineOperation::connect_bootloader()
{
    QByteArray received;
    QByteArray seed;
    QByteArray seed_key;
 ...
 *
 */
int FlashEcuSubaruMitsuM32rKlineOperation::read_mem(uint32_t start_addr, uint32_t length)
{
    QElapsedTimer timer;
...
int FlashEcuSubaruMitsuM32rKlineOperation::write_mem(bool test_write)
{
    QByteArray received;
    QByteArray filedata;
...
int FlashEcuSubaruMitsuM32rKlineOperation::reflash_block(const uint8_t *newdata, const struct flashdev_t *fdt, unsigned blockno, bool test_write)
{
 ...
 * @return received response
 */
QByteArray FlashEcuSubaruMitsuM32rKlineOperation::send_sid_b8_byte_read(uint32_t addr)
{
    QByteArray output;
    QByteArray received;
 ...
 * @return received response
 */
QByteArray FlashEcuSubaruMitsuM32rKlineOperation::send_sid_a0_block_read(uint32_t addr, uint32_t len)
{
    QByteArray output;
    QByteArray received;
    QByteArray msg;
 ...
 */
QByteArray FlashEcuSubaruMitsuM32rKlineOperation::send_sid_bf_ssm_init()
{
    QByteArray output;
    QByteArray received;
 ...
 * @return received response
 */
QByteArray FlashEcuSubaruMitsuM32rKlineOperation::send_sid_81_start_communication()
{
    QByteArray output;
    QByteArray received;
 ...
 * @return received response
 */
QByteArray FlashEcuSubaruMitsuM32rKlineOperation::send_sid_83_request_timings()
{
    QByteArray output;
    QByteArray received;
 ...
 * @return seed (4 bytes)
 */
QByteArray FlashEcuSubaruMitsuM32rKlineOperation::send_sid_27_request_seed()
{
    QByteArray output;
    QByteArray received;
 ...
 * @return received response
 */
QByteArray FlashEcuSubaruMitsuM32rKlineOperation::send_sid_10_start_diagnostic()
{
    QByteArray output;
    QByteArray received;
