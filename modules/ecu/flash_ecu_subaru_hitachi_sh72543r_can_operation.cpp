 ...
 * @return success
 */
int FlashEcuSubaruHitachiSH72543rCanOperation::reflash_block(const uint8_t *newdata, const struct flashdev_t *fdt, unsigned blockno, bool test_write)
{
 ...
 */
QByteArray FlashEcuSubaruHitachiSH72543rCanOperation::generate_can_seed_key(QByteArray requested_seed)
{
    QByteArray key;
 ...
 * @return seed key (4 bytes)
 */
QByteArray FlashEcuSubaruHitachiSH72543rCanOperation::calculate_seed_key(QByteArray requested_seed, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray key;
...
QByteArray FlashEcuSubaruHitachiSH72543rCanOperation::encrypt_payload(QByteArray buf, uint32_t len)
{
...
QByteArray FlashEcuSubaruHitachiSH72543rCanOperation::decrypt_payload(QByteArray buf, uint32_t len)
{
    QByteArray decrypt;
...
QByteArray FlashEcuSubaruHitachiSH72543rCanOperation::calculate_payload(QByteArray buf, uint32_t len, const uint16_t *keytogenerateindex, const uint8_t *indextransformation)
{
    QByteArray encrypted;
 ...
 */
QString FlashEcuSubaruHitachiSH72543rCanOperation::parse_message_to_hex(QByteArray received)
{
    QString msg;
