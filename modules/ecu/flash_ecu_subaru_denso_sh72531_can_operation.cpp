 ...
 */
QByteArray FlashEcuSubaruDensoSH72531CanOperation::generate_can_seed_key(QByteArray requested_seed)
{
    QByteArray key;
...
QByteArray FlashEcuSubaruDensoSH72531CanOperation::encrypt_payload(QByteArray buf, uint32_t len)
{
...
QByteArray FlashEcuSubaruDensoSH72531CanOperation::decrypt_payload(QByteArray buf, uint32_t len)
{
    QByteArray decrypt;
