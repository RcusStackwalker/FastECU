 ...
 * @return success
 */
int FlashEcuSubaruHitachiSH7058CanOperation::reflash_block_subaru_ecu_hitachi_can(const uint8_t *newdata, const struct flashdev_t *fdt, unsigned blockno, bool test_write)
{
