...
the expected response prefix `63 27 34`; the existing minimum-length guard
remains in force. Do not continue accepting `63 27 42`, because there is no
ECU-side evidence that it grants access.
