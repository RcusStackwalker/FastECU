/**********************************************
* THIS IS A PIN OUT FOR USE WITH ARDUINO NANO
*
*
* This pinout list is as read on the printed Board
* DSO_pin = 2        // D2
* DSI_pin = 3        // D3
* RESET_pin = 4      // D4
* FREEZE_pin = 5     // D5
...
int DSO_pin = 2;        // PORTD pin2
int DSI_pin = 3;        // PORTD pin3
int RESET_pin = 4;      // PORTD pin4
int FREEZE_pin = 5;     // PORTD pin5
int BKPT_pin = 6;       // PORTD pin6
int DSCLK_pin = 7;      // PORTD pin7
int CLKOUT_pin = 8;     // PORTB pin0
int BERR_pin = 9;       // PORTB pin1
int DS_pin = 10;        // PORTB pin2
int MCU_RESET_pin = 11; // PORTB pin3
