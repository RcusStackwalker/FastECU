...
MUT_DMA_TESTS_COMMON_HDRS = [
    ...
    "tests/test_eeprom_ecu_subaru_denso_sh705x_can_dialog.h",
    "tests/test_eeprom_ecu_subaru_denso_sh705x_kline_dialog.h",
    "tests/test_file_actions_parsing.h",
    "tests/test_flash_ecu_mitsu_m32r_can_operation.h",
    "tests/test_flash_event_adapter.h",
    "tests/test_flash_operation_worker.h",
    "tests/test_flash_utils.h",
    "tests/test_flash_worker.h",
