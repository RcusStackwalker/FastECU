...
MUT_DMA_TESTS_COMMON_SRCS = [
    ...
    "tests/test_eeprom_ecu_subaru_denso_sh705x_can_operation_characterization.cpp",
...
MUT_DMA_TESTS_COMMON_HDRS = [
    ...
    "tests/test_eeprom_ecu_subaru_denso_sh705x_can_operation_characterization.h",
    "tests/test_eeprom_ecu_subaru_denso_sh705x_kline_operation_characterization.h",
